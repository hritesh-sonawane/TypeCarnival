...
function drawDot(x: number, y: number) {
  ...
  // updates imageData by checking the result of isPointInImage()
}
 ...
 * future module.
 *
 * In computing, row-major order and column-major order
 * are methods for storing multidimensional arrays
